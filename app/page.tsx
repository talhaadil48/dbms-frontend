  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-background to-background/80">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-blue-500/5 dark:bg-purple-500/5"></div>
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 rounded-full bg-purple-500/5 dark:bg-blue-500/5"></div>
        <div className="absolute top-2/3 left-2/3 w-48 h-48 rounded-full bg-blue-500/5 dark:bg-purple-500/5"></div>
        <div className="absolute top-1/2 right-1/2 w-72 h-72 rounded-full bg-purple-500/5 dark:bg-blue-500/5"></div>
      </div>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-24 relative z-10">
        <div className="flex flex-col items-center justify-center w-full max-w-6xl">
          ...
          <div className="mb-16 text-center relative">
              ...
              <div className="relative w-32 h-32 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                ...
                <div className="absolute inset-0 rounded-full flex items-center justify-center">
                  <div className="w-28 h-28 rounded-full bg-background flex items-center justify-center">
                    <Image src="/logo.png" alt="NexusAI Logo" width={75} height={75} />
                  </div>
                </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
              AI Chatbot Platform
            </h1>
          ...
          {/* Features section */}
          <h2 className="text-3xl font-bold mb-8 text-center">Cutting-Edge Features</h2>
          ...
          <div className="mt-16 text-center">
            <Link href="/login?type=admin">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden group"
              >
            ...
            <p className="mt-4 text-sm text-muted-foreground">Experience the next generation of AI chatbots</p>
          </div>
        </div>
      </div>
    </main>
